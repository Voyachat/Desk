...
import { PwshLocalExecutor } from '@voyaseek-ai/dsh-pwsh-local'
import LocalSubprocessRuntime from '@voyaseek-ai/dsh-subprocess-local'
import LocalFileSystem from '@voyaseek-ai/dsh-fs-local'
import { AttachmentStore } from '@voyaseek-ai/dsh-attachment'
import type { ImageAttachmentLimits, ImageAttachmentRef, SaveImageAttachment, StoredImageAttachment } from '@voyaseek-ai/dsh-attachment'
import UserQuestionService from '@voyaseek-ai/dsh-user-questions'
import PlanModeController from '@voyaseek-ai/dsh-plan-mode'
import WebRuntime from '@voyaseek-ai/dsh-web'
import * as WebSearchExa from '@voyaseek-ai/dsh-web-search-exa'
import * as WebFetchLocal from '@voyaseek-ai/dsh-web-fetch-http'
import SubagentRuntime from '@voyaseek-ai/dsh-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@voyaseek-ai/dsh-subagent'
import * as ToolSubagentControl from '@voyaseek-ai/dsh-tool-subagent-control'
import * as ToolSubagentListAgents from '@voyaseek-ai/dsh-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@voyaseek-ai/dsh-tool-subagent-report'
import SkillRegistry from '@voyaseek-ai/dsh-skill'
import * as SkillFileSystem from '@voyaseek-ai/dsh-skill-filesystem'
import LocalJobRegistry from '@voyaseek-ai/dsh-jobs-local'
import * as ToolAskUser from '@voyaseek-ai/dsh-tool-ask-user'
...
import * as ToolSchedule from '@voyaseek-ai/dsh-schedule'
import Lsp from '@voyaseek-ai/dsh-lsp'
import * as ToolLsp from '@voyaseek-ai/dsh-tool-lsp'
import * as ToolSkill from '@voyaseek-ai/dsh-tool-skill'
import * as ToolSessionQuery from '@voyaseek-ai/dsh-tool-session-query'
import * as ToolTasks from '@voyaseek-ai/dsh-tool-jobs'
import * as ToolTodo from '@voyaseek-ai/dsh-tool-todo'
import * as ToolSubagent from '@voyaseek-ai/dsh-tool-subagent'
import * as ToolWeb from '@voyaseek-ai/dsh-tool-web'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@voyaseek-ai/dsh-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-cordis',
    dir: 'tool-cordis',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-str-replace-editor',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-terminal',
    dir: 'tool-terminal',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-ralph',
    dir: 'tool-ralph',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-skill',
    dir: 'tool-skill',
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        dshHome: resolve(root, '.tmp/tool-catalog/.voyaseek'),
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-session-query',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-subagent-control',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-subagent-report',
  ...
  {
    pkg: '@voyaseek-ai/dsh-tool-workflow',
    dir: 'tool-workflow',
