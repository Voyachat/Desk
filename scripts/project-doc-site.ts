...
const REPOSITORY_URL = 'https://github.com/voyaseek-ai/voyaseek-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/voyaseek-ai/voyaseek-harness/${repositoryRef}/${path}${suffix}`
