...
import type { CordisCatalogModel, ServiceMethodEntry } from '@voyaseek-ai/dsh-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@voyaseek-ai/dsh-tool-cordis/api-catalog', '@voyaseek-ai/dsh-cordis-client-runner/client/api-catalog')
