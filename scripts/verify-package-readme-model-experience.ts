...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  'packages/document/document-converter-mac-ocr': { kind: 'indirect', reason: 'The Host image fallback consumer owns whether OCR Markdown enters a text-model request.' },
  'packages/document/document-converter': { kind: 'indirect', reason: 'Consumers decide whether recorded converted Markdown enters a model request.' },
  'packages/host/mobile-view': { kind: 'none', reason: 'The read-only viewer projects committed Session events and never changes model input.' },
  'packages/client/ui-settings-mobile-view': { kind: 'none', reason: 'Browser-side listener settings register no model input.' },
  'packages/aistaff/supervisor-control': { kind: 'none', reason: 'The privileged Host control service registers no DSH prompt, message, event, or tool schema.' },
  'packages/aistaff/product-remote': { kind: 'none', reason: 'The Renderer bridge carries product projections and operations without registering model input.' },
  'packages/aistaff/product-projection': { kind: 'none', reason: 'The Host projection service registers no model input.' },
  'packages/aistaff/product-contracts': { kind: 'none', reason: 'The package exports product data contracts and registers no model input.' },
  'packages/aistaff/product-bundle': { kind: 'none', reason: 'The bundle composes Host and Client plugins whose owners declare any model-visible behavior.' },
  'packages/aistaff/local-capability': { kind: 'none', reason: 'The local authorization service registers no DSH prompt, message, event, or tool schema.' },
  'packages/aistaff/local-capability-remote': { kind: 'none', reason: 'The Renderer bridge carries authorization operations and display-safe projections without registering model input.' },
  'packages/aistaff/local-capability-conformance': { kind: 'none', reason: 'The test-only local capability fixture registers no model input.' },
  'packages/aistaff/employee-experience': { kind: 'none', reason: 'The Renderer-safe business projection service registers no model input.' },
  'packages/aistaff/employee-experience-remote': { kind: 'none', reason: 'The Renderer bridge carries business projections and user operations without registering model input.' },
  'packages/aistaff/cloud-provider': { kind: 'none', reason: 'The Host provider publishes an Employee Experience adapter and registers no model input.' },
  'packages/aistaff/cloud-product-bundle': { kind: 'none', reason: 'The production bundle composes Host and Client packages whose owners declare any model-visible behavior.' },
  'packages/aistaff/cloud-local-conformance': { kind: 'none', reason: 'The test-only end-to-end fixture publishes Renderer-safe state and registers no model input.' },
  'packages/aistaff/cloud-local-conformance-bundle': { kind: 'none', reason: 'The test-only bundle composes conformance fixtures and registers no model input.' },
  'packages/aistaff/cloud-local-client-product': { kind: 'none', reason: 'Browser-side workbench composition renders existing projections and registers no model input.' },
  'packages/aistaff/cloud-conformance': { kind: 'none', reason: 'The test-only Cloud fixture publishes Renderer-safe business state and registers no model input.' },
  'packages/aistaff/cloud-conformance-bundle': { kind: 'none', reason: 'The test-only bundle composes conformance fixtures and registers no model input.' },
  'packages/aistaff/cloud-client': { kind: 'none', reason: 'The Host gateway adapter publishes Renderer-safe business projections and registers no model input.' },
  'packages/aistaff/cloud-client-product': { kind: 'none', reason: 'Browser-side Cloud composition registers product UI only and no model input.' },
  'packages/aistaff/client-product': { kind: 'none', reason: 'Browser-side product controls render admitted projections and register no model input.' },
  ...
  'packages/client/ui-settings-memory': { kind: 'none', reason: 'Browser-side settings page; the agent-memory context consumer owns the recalled model message.' },
  ...
  'packages/memory/agent-memory': { kind: 'indirect', reason: 'The service definition delegates model rendering to the agent-memory context consumer.' },
  'packages/memory/agent-memory-settings': { kind: 'indirect', reason: 'The storage provider delegates model rendering to the agent-memory context consumer.' },
