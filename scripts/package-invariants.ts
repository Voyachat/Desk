...
function checkManifest(
  ...
  if (owner.packageName === '@voyaseek-ai/dsh-invariants') return
  if (manifest.peerDependencies?.['@voyaseek-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@voyaseek-ai/dsh-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@voyaseek-ai/dsh-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@voyaseek-ai/dsh-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@voyaseek-ai/dsh-invariants'
