...
来源：[`packages/interaction/user-approval/src/index.ts:57`](../packages/interaction/user-approval/src/index.ts)
...
<a id="claude-agentruntime--log-only"></a>

#### `claude-agent/runtime` — log-only
...
来源：[`packages/workflow/tool-workflow/src/types.ts:61`](../packages/workflow/tool-workflow/src/types.ts)
...
来源：[`packages/workflow/tool-workflow/src/types.ts:56`](../packages/workflow/tool-workflow/src/types.ts)
