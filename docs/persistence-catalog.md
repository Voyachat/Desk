...
Source: [`packages/workflow/tool-workflow/src/types.ts:61`](../packages/workflow/tool-workflow/src/types.ts)
...
Source: [`packages/workflow/tool-workflow/src/types.ts:56`](../packages/workflow/tool-workflow/src/types.ts)
