/**
 * `@voyaseek-ai/dsh-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @voyaseek-ai/dsh-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'voyaseek-harness/0.0.1 (+https://github.com/voyaseek-ai)'
