 ...
 * `@voyaseek-ai/dsh-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @voyaseek-ai/dsh-web-fetch-http/provider
 */

import { WebError } from '@voyaseek-ai/dsh-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@voyaseek-ai/dsh-web'
