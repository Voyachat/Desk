 ...
 * @module @voyaseek-ai/dsh-web-search-deepseek/provider
 */
...
import type {
  ...
  WebSearchResult,
  WebSearchSource,
} from '@voyaseek-ai/dsh-web'
import type { CredentialRef } from '@voyaseek-ai/dsh-credentials'
import type {} from '@voyaseek-ai/dsh-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@voyaseek-ai/dsh-llm-deepseek` uses, so this
...
const USER_AGENT = 'voyaseek-harness/0.0.1'
