/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-web-search-deepseek`.
 * @module @voyaseek-ai/dsh-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-web-search-deepseek'
