...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@voyaseek-ai/dsh-tools'
import type { WebFetchBody, WebFetchResult } from '@voyaseek-ai/dsh-web'
 ...
 * `@voyaseek-ai/dsh-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@voyaseek-ai/dsh-tool-call-timeout-policy` to enforce.
