/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-directory-picker-browse`.
 * @module @voyaseek-ai/dsh-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-directory-picker-browse'
