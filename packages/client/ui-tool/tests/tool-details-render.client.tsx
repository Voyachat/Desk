...
import type { SessionProviderComponent, TranslateNS } from '@voyaseek-ai/dsh-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@voyaseek-ai/dsh-client-ui-conversation/src/client/contract/slots.ts'
