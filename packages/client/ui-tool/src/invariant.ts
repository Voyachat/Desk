/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-tool`.
 * @module @voyaseek-ai/dsh-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-tool'
