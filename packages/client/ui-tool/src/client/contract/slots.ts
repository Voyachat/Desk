...
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@voyaseek-ai/dsh-client-ui-slots'
import type { ToolCallBlock } from '@voyaseek-ai/dsh-client-runtime/client'
