 ...
 * ({@link module:@voyaseek-ai/dsh-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@voyaseek-ai/dsh-client-ui-primitives'
