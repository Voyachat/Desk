/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-user-questions`.
 * @module @voyaseek-ai/dsh-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-user-questions'
