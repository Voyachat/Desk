/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-jobs`.
 * @module @voyaseek-ai/dsh-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-jobs'
