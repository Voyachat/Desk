/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-sidebar`.
 * @module @voyaseek-ai/dsh-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-sidebar'
