...
import type { SessionId, SessionSummary } from '@voyaseek-ai/dsh-api-remotes/client'
...
export interface SessionListEntry {
  ...
  agentPreset?: string
  /** Agent driver runtime the session runs under (summary passthrough); absent = default loop driver. */
  agentRuntime?: string
  /** Current host-computed projection values for list consumers. */
  projectionValues?: Readonly<Partial<SessionProjectionMap>>
