/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-runtime`.
 * @module @voyaseek-ai/dsh-client-runtime/invariant
 */
...
import type { SlotMap } from '@voyaseek-ai/dsh-client-ui-slots'
import type { InvariantInstaller } from '@voyaseek-ai/dsh-invariants'

const PACKAGE_NAME = '@voyaseek-ai/dsh-client-runtime'
