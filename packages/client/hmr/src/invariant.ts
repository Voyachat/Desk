/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-hmr`.
 * @module @voyaseek-ai/dsh-client-hmr/invariant
 */

import type { Context, Fiber } from '@voyaseek-ai/cordis'
import type { InvariantInstaller } from '@voyaseek-ai/dsh-invariants'

const PACKAGE_NAME = '@voyaseek-ai/dsh-client-hmr'
