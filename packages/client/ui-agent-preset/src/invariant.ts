/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-agent-preset`.
 * @module @voyaseek-ai/dsh-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-agent-preset'
