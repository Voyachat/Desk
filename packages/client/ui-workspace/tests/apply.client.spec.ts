...
import { apply, inject } from '@voyaseek-ai/dsh-client-ui-workspace/client'
import type { WorkspaceBrowserInjected, WorkspacePickerInjected } from '@voyaseek-ai/dsh-client-ui-workspace/client'
