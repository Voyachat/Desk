/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-workspace`.
 * @module @voyaseek-ai/dsh-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-workspace'
