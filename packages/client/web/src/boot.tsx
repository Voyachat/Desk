...
import * as ModulesClient from '@voyaseek-ai/dsh-client-modules/client'
import {
  ClientModuleSystem, parseBootManifest,
  type BootManifest, type ClientModuleSystemOptions, type DshWindow,
} from '@voyaseek-ai/dsh-client-modules/client'
 ...
 * twice.
 */
const MODULES_ID = '@voyaseek-ai/dsh-client-modules'
