/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-slots`.
 * @module @voyaseek-ai/dsh-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-slots'
