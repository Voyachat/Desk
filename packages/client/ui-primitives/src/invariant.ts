/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-primitives`.
 * @module @voyaseek-ai/dsh-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-primitives'
