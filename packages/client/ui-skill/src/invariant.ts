/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-skill`.
 * @module @voyaseek-ai/dsh-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-skill'
