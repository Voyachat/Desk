/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-goal`.
 * @module @voyaseek-ai/dsh-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-goal'
