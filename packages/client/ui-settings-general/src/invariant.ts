/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-settings-general`.
 * @module @voyaseek-ai/dsh-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-settings-general'
