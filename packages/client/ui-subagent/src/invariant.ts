/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-subagent`.
 * @module @voyaseek-ai/dsh-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-subagent'
