/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-theme`.
 * @module @voyaseek-ai/dsh-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-theme'
