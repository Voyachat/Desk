# @voyaseek-ai/dsh-client-modules
...
- **No unload bookkeeping of its own** — style removal and fiber teardown ordering live with the HMR driver (`@voyaseek-ai/dsh-client-hmr`); the loader only inventories owned style tag ids per record.
