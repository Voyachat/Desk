/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-modules`.
 * @module @voyaseek-ai/dsh-client-modules/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-modules'
