/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-input-trigger`.
 * @module @voyaseek-ai/dsh-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-input-trigger'
