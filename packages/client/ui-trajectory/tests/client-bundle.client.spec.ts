 ...
 * not built (`pnpm --filter @voyaseek-ai/dsh-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@voyaseek-ai/dsh-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@voyaseek-ai/dsh-client-runtime/client', await import('@voyaseek-ai/dsh-client-runtime/client')],
      ['@voyaseek-ai/dsh-client-ui-primitives', await import('@voyaseek-ai/dsh-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@voyaseek-ai/dsh-client-locale/client')
