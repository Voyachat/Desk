/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-trajectory`.
 * @module @voyaseek-ai/dsh-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-trajectory'
