/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-settings-plugins`.
 * @module @voyaseek-ai/dsh-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-settings-plugins'
