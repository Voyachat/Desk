...
import * as PluginConfigInvariant from '@voyaseek-ai/dsh-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@voyaseek-ai/dsh-client-ui-settings-plugins')
