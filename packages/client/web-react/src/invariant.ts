/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-web-react`.
 * @module @voyaseek-ai/dsh-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-web-react'
