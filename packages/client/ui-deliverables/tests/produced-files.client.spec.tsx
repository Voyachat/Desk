...
import type { ChatFileMentions, TurnTailOwnerProps } from '@voyaseek-ai/dsh-client-ui-conversation/client'
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@voyaseek-ai/dsh-client-ui-deliverables'])
