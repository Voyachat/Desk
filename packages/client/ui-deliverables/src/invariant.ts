/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-deliverables`.
 * @module @voyaseek-ai/dsh-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-deliverables'
