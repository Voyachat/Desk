/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-schema-form`.
 * @module @voyaseek-ai/dsh-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-schema-form'
