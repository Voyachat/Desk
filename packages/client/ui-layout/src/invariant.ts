/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-layout`.
 * @module @voyaseek-ai/dsh-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-layout'
