...
import { apply as nodeApply } from '@voyaseek-ai/dsh-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@voyaseek-ai/dsh-client-locale/client'
import * as LocaleInvariant from '@voyaseek-ai/dsh-client-locale/invariant'
