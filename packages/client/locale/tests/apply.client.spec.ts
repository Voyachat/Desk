...
import { SettingsScopeBinder } from '@voyaseek-ai/dsh-client-ui-settings/client'
import { TestRemote } from '@voyaseek-ai/dsh-client-test-runtime'
import {
  apply, inject, SETTINGS_NS,
} from '@voyaseek-ai/dsh-client-locale/client'
import type { LanguageRowInjected, LocaleRuntime } from '@voyaseek-ai/dsh-client-locale/client'
...
async function bench() {
  ...
  // Most wiring cases start from an already persisted product default. Fresh
  // browser adoption has dedicated LocaleRuntime and real-Web coverage.
  let preference: string | undefined = 'zh'
  let revision = 0
  const namespace = () => ({
