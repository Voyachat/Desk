/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-message-feedback`.
 * @module @voyaseek-ai/dsh-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-message-feedback'
