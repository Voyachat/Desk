/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-conversation`.
 * @module @voyaseek-ai/dsh-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-conversation'
