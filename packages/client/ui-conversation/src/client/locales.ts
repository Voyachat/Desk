...
export const zh = {
  ...
  'image.fallbackFailed': '图片解析失败，请检查视觉模型配置或切换支持图片的模型',
  ...
  'settings.reasoning.title': '思考过程展示',
  'settings.reasoning.description': '逐行展示时，思考步骤独立成行，并在生成期间自动展开',
  'settings.reasoning.inline': '逐行展示',
  'settings.reasoning.folded': '折叠进活动行',
  'access.menu.title': '智能体应如何执行文件操作？',
  'access.mode.readOnly.title': '请求批准',
  'access.mode.readOnly.description': '默认保持只读；需要写入时请求你的批准。',
  'access.mode.workspaceWrite.title': '帮我批准',
  'access.mode.workspaceWrite.description': '可直接修改当前项目；需要扩大文件访问范围时请求批准。',
  'access.mode.fullAccess.title': '完全访问权限',
  'access.mode.fullAccess.description': '可修改电脑上的任意文件，并跳过权限确认。',
  'access.confirm.title': '确认启用完全访问权限？',
  'access.confirm.description': '启用后，当前会话可修改电脑上的任意文件，并跳过权限确认。仅在你信任当前任务时使用。',
  'access.confirm.acknowledge': '我已了解风险，并愿意继续',
  'access.confirm.cancel': '取消',
  'access.confirm.enable': '启用完全访问权限',
  'hero.headline': '伟大征程，始于微光。\nEvery Great Journey Begins with a Glimmer',
  'hero.preview': '预览版',
  ...
  'todo.progress.failed': '{failed} 失败',
  'todo.progress.blocked': '{blocked} 已阻止（本轮未执行）',
  ...
  'message.context.memory.count': '{count} 条相关记忆',
  ...
  'message.turnError.quota.title': '模型额度已用尽',
  'message.turnError.quota.hint': '请检查账户额度或账单，恢复后重试。',
  'message.turnError.rateLimit.title': '模型请求过于频繁',
  'message.turnError.rateLimit.hint': '模型服务正在限流，请稍后重试。',
  'message.turnError.rateLimit.retryAfter': '模型服务正在限流，请在约 {seconds} 秒后重试。',
  'message.turnError.auth.title': '模型认证失败',
  'message.turnError.auth.hint': '请检查 API Key 或登录凭据，更新后重试。',
  'message.turnError.network.title': '无法连接模型服务',
  'message.turnError.network.hint': '请检查网络、代理和服务地址，然后重试。',
  'message.turnError.timeout.title': '模型响应超时',
  'message.turnError.timeout.hint': '请稍后重试；若持续发生，请检查网络或缩短请求。',
  'message.turnError.providerUnavailable.title': '模型服务暂时不可用',
  'message.turnError.providerUnavailable.hint': '请稍后重试，或切换到其他可用模型。',
  'message.turnError.modelAccess.title': '当前账号未开通此模型',
  'message.turnError.modelAccess.hint': '请在模型提供方控制台开通，或切换到已开通的对话模型。',
  'message.turnError.contextWindow.title': '上下文长度超限',
  'message.turnError.contextWindow.hint': '请缩短输入、开启新会话，或先压缩上下文后重试。',
  'message.turnError.invalidRequest.title': '模型拒绝了请求',
  'message.turnError.invalidRequest.hint': '请检查输入和请求参数，必要时切换模型后重试。',
  'message.turnError.configuration.title': '当前模型配置不可用',
  'message.turnError.configuration.hint': '请检查模型与参数设置，或切换到其他可用模型后重试。',
  'message.turnError.unknown.title': '模型请求失败',
  'message.turnError.unknown.hint': '请重试；若持续发生，请展开诊断信息并联系支持。',
  'message.turnError.diagnostics': '诊断信息',
  ...
  'activity.running': '正在处理',
  'activity.done': '已处理',
  'activity.steps': '{steps} 步',
  'activity.tool.running': '正在执行 {name}',
  'activity.tool.success': '已完成 {name}',
  'activity.tool.error': '{name} 失败',
  ...
  'approval.reject': '拒绝',
  'approval.allowOnce': '允许这一次',
  'approval.allowAndRemember': '允许并在当前会话记住',
  'ask.rowTitle': '提问',
  'ask.waiting': '等待回答',
  'ask.cancelled': '已取消',
  'ask.interrupted': '已中断',
...
export const en = {
  ...
  'image.fallbackFailed': 'Image analysis failed; check the vision-model configuration or switch to an image-capable model',
  ...
  'settings.reasoning.title': 'Reasoning display',
  'settings.reasoning.description': 'Inline shows each thinking step as its own row, expanded while it streams',
  'settings.reasoning.inline': 'Inline rows',
  'settings.reasoning.folded': 'Fold into activity',
  'access.menu.title': 'How should the agent handle file operations?',
  'access.mode.readOnly.title': 'Ask for approval',
  'access.mode.readOnly.description': 'Keep files read-only by default and ask before a requested write.',
  'access.mode.workspaceWrite.title': 'Agent approval',
  'access.mode.workspaceWrite.description': 'Allow changes in this project and ask before widening file access.',
  'access.mode.fullAccess.title': 'Full access',
  'access.mode.fullAccess.description': 'Allow changes to any file on this computer without permission prompts.',
  'access.confirm.title': 'Enable Full access?',
  'access.confirm.description': 'Full access lets this session change any file on this computer without permission prompts. Only use it when you trust the current task.',
  ...
  'todo.progress.failed': '{failed} failed',
  'todo.progress.blocked': '{blocked} blocked (not run this turn)',
  ...
  'message.context.memory.count': '{count} relevant memories',
  ...
  'message.turnError.quota.title': 'Model quota exhausted',
  'message.turnError.quota.hint': 'Check the account quota or billing, then retry after service is restored.',
  'message.turnError.rateLimit.title': 'Too many model requests',
  'message.turnError.rateLimit.hint': 'The model provider is rate limiting requests. Please retry shortly.',
  'message.turnError.rateLimit.retryAfter': 'The model provider is rate limiting requests. Retry in about {seconds} seconds.',
  'message.turnError.auth.title': 'Model authentication failed',
  'message.turnError.auth.hint': 'Check the API key or sign-in credentials, update them, and retry.',
  'message.turnError.network.title': 'Cannot reach the model provider',
  'message.turnError.network.hint': 'Check the network, proxy, and service endpoint, then retry.',
  'message.turnError.timeout.title': 'The model request timed out',
  'message.turnError.timeout.hint': 'Retry shortly. If this continues, check the network or shorten the request.',
  'message.turnError.providerUnavailable.title': 'The model provider is unavailable',
  'message.turnError.providerUnavailable.hint': 'Retry shortly or switch to another available model.',
  'message.turnError.modelAccess.title': 'This account does not have access to the model',
  'message.turnError.modelAccess.hint': 'Enable it in the provider console or switch to a chat model this account can access.',
  'message.turnError.contextWindow.title': 'The context window was exceeded',
  'message.turnError.contextWindow.hint': 'Shorten the input, start a new conversation, or compact context before retrying.',
  'message.turnError.invalidRequest.title': 'The model rejected the request',
  'message.turnError.invalidRequest.hint': 'Check the input and request settings, or switch models, then retry.',
  'message.turnError.configuration.title': 'The current model configuration is unavailable',
  'message.turnError.configuration.hint': 'Check the model and settings, or switch to another available model, then retry.',
  'message.turnError.unknown.title': 'The model request failed',
  'message.turnError.unknown.hint': 'Retry. If this continues, expand the diagnostics and contact support.',
  'message.turnError.diagnostics': 'Diagnostics',
  ...
  'activity.done': 'Processed',
  'activity.steps': '{steps} steps',
  'activity.tool.running': 'Running {name}',
  'activity.tool.success': 'Completed {name}',
  'activity.tool.error': '{name} failed',
  ...
  'approval.allowAndRemember': 'Allow and remember for this session',
