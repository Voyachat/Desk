...
import { Tooltip } from '@voyaseek-ai/dsh-client-ui-primitives'
import type { ConversationSnapshot, UseProjection } from '@voyaseek-ai/dsh-client-runtime/client'
import type { SnapshotSelectorHook } from '@voyaseek-ai/dsh-client-ui-slots'
// Type-only: merges the sessionStats key into SessionProjectionMap for useProjection.
import type {} from '@voyaseek-ai/dsh-session-stats/client'
import type { TokenUsageProjection } from '@voyaseek-ai/dsh-token-meter/client'
import type { ComposerBarProps } from '../contract/slots.ts'
import { formatTokensPerSecond } from './message-chrome.ts'
import { formatTokens } from '../contract/context-metrics.ts'
