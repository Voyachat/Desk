...
import { AttachmentRail, DropOverlay, ImageLightbox } from '@voyaseek-ai/dsh-client-ui-attachment'
import type { AttachmentRailItem } from '@voyaseek-ai/dsh-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@voyaseek-ai/dsh-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@voyaseek-ai/dsh-goal/client'
