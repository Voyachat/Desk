...
export const zh = {
  ...
  'catalog.goal-complex.label': '复杂任务目标',
  'catalog.goal-complex.description': '分阶段执行并独立验证复杂任务目标',
...
export const en = {
  ...
  'catalog.goal-complex.label': 'Complex task goal',
  'catalog.goal-complex.description': 'Execute a complex objective in stages with independent verification',
