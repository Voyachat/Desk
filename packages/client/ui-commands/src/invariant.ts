/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-commands`.
 * @module @voyaseek-ai/dsh-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-commands'
