/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-attachment`.
 * @module @voyaseek-ai/dsh-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-attachment'
