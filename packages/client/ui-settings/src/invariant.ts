/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-settings`.
 * @module @voyaseek-ai/dsh-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-settings'
