/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-plan`.
 * @module @voyaseek-ai/dsh-client-ui-plan/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-plan'
