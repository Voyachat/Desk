/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-directory-picker-native`.
 * @module @voyaseek-ai/dsh-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-directory-picker-native'
