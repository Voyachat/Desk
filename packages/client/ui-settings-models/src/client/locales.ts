...
export const en = {
  ...
  runtimeCodex: 'Codex',
  runtimeSupported: 'Protocol configured',
  runtimeUnsupported: 'Protocol not configured',
  runtimeUnprobed: 'Unverified',
  runtimeReachable: 'Reachable',
  runtimeFailed: 'Failed',
  runtimeProbe: 'Check connections (minimal request)',
  runtimeProbing: 'Checking…',
  runtimeProbeSaveFirst: 'Save this provider before checking its stored credential and endpoints.',
  addModel: 'Add model',
  ...
  fetchModels: 'Fetch model catalog',
  ...
  fetchDescription: 'The endpoint lists these model IDs, but does not confirm chat support or access for this account. Select only models you have enabled for chat.',
  fetchManufacturer: 'Filter by model maker',
  fetchManufacturerAll: 'All',
  fetchSearch: 'Search models',
  fetchSearchPlaceholder: 'Search model ID or display name',
  fetchNoMatches: 'No models match this filter.',
  ...
  customNeedsDisplayName: 'Enter a display name. The internal Provider ID is generated automatically.',
  customApi: 'API protocol',
  customApiUnset: 'Not selected',
  customNeedsBaseUrl: 'A custom provider needs a base URL.',
  customNeedsModels: 'A custom provider needs at least one model.',
  requestConfigurations: 'Request configurations',
  requestConfigurationsHint: 'The first endpoint serves Native requests. Additional Responses and Anthropic endpoints let the same API key serve Codex and Claude. These labels check configuration only; model access is still determined by the provider.',
  primaryRequestConfiguration: 'Primary · Native',
  alternateRequestConfiguration: 'Alternative runtime',
  addRequestConfiguration: 'Add request configuration',
  removeRequestConfiguration: 'Delete request configuration',
  requestConfigurationDuplicate: 'Each API protocol can be configured only once.',
  providerAdviceKey: 'Detected {provider} from the API-key prefix and filled its built-in configuration advice.',
  providerAdviceName: 'Built-in {provider} configuration advice is available for this provider name.',
  providerAdviceReady: 'The current endpoints match the built-in {provider} configuration advice.',
  providerAdviceAmbiguous: 'This API-key prefix is shared by several providers. Enter the provider name or endpoints; the key alone cannot identify them safely.',
  providerAdviceUnknown: 'No built-in provider recipe matches yet. Enter the provider name and primary endpoint.',
  repairConfiguration: 'Apply smart repair',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  runtimeCompatibility: '模式兼容性',
  runtimeNative: 'Native',
  runtimeClaude: 'Claude',
  runtimeCodex: 'Codex',
  runtimeSupported: '协议已配置',
  runtimeUnsupported: '协议未配置',
  runtimeUnprobed: '未确认',
  runtimeReachable: '已连通',
  runtimeFailed: '连接失败',
  runtimeProbe: '检查连通性（发送最小请求）',
  runtimeProbing: '检查中…',
  runtimeProbeSaveFirst: '请先保存提供方，再使用已存凭据和端点检查连通性。',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  fetchTitle: '选择要添加的模型',
  fetchDescription: '端点列出了这些模型 ID，但不代表当前账号已开通，也不代表它们支持对话。请只选择已开通的对话模型。',
  fetchManufacturer: '按模型厂商筛选',
  fetchManufacturerAll: '全部',
  fetchSearch: '搜索模型',
  fetchSearchPlaceholder: '搜索模型 ID 或显示名称',
  fetchNoMatches: '没有符合筛选条件的模型。',
  fetchAdopt: '添加所选',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  ...
  customNeedsDisplayName: '请输入显示名称；内部 Provider ID 会自动生成，无需手工填写。',
  customApi: 'API 协议',
  customApiUnset: '未选择',
  customNeedsBaseUrl: '自定义提供方需要填写 API 地址。',
  customNeedsModels: '自定义提供方至少需要一个模型。',
  requestConfigurations: '请求配置',
  requestConfigurationsHint: '第一项用于 Native 请求；增加 Responses 与 Anthropic 端点后，同一个 API Key 也可供 Codex 和 Claude 使用。这里仅检查配置是否齐全，模型权限仍由提供商决定。',
  primaryRequestConfiguration: '主请求 · Native',
  alternateRequestConfiguration: '兼容请求',
  addRequestConfiguration: '添加请求配置',
  removeRequestConfiguration: '删除请求配置',
  requestConfigurationDuplicate: '每种 API 协议只能配置一次。',
  providerAdviceKey: '已根据 API Key 前缀识别为 {provider}，并自动填写内置配置建议。',
  providerAdviceName: '可按提供方名称应用内置的 {provider} 配置建议。',
  providerAdviceReady: '当前端点符合内置的 {provider} 配置建议。',
  providerAdviceAmbiguous: '多个提供方共用此前缀，无法只凭 API Key 安全识别；请填写提供方名称或请求地址。',
  providerAdviceUnknown: '暂未匹配到内置的提供方配置；请填写显示名称和主请求地址。',
  repairConfiguration: '智能修复配置',
  create: '创建提供方',
  creating: '创建中\u2026',
  ...
  onboardingDescription: '配置模型服务，即可开始使用。',
