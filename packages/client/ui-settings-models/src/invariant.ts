/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-settings-models`.
 * @module @voyaseek-ai/dsh-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-settings-models'
