/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-permission-presets`.
 * @module @voyaseek-ai/dsh-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-permission-presets'
