/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-connection`.
 * @module @voyaseek-ai/dsh-client-connection/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-connection'
