...
import type { ApiProxy } from '@voyaseek-ai/dsh-host-apiproxy/api'
import type { AttachmentStore } from '@voyaseek-ai/dsh-attachment'
import { RpcId, type ClientRequest } from '@voyaseek-ai/dsh-host-apiproxy/api'
import type { WebServer, WebRoute, WebUpgradeRoute } from '@voyaseek-ai/dsh-host-webserver'
...
describe('connection node half', () => {
  ...
  it('pins privileged methods to loopback even for a declared trusted authority', async () => {
    ...
    for (const method of [
      ...
      'llm.discoverModels',
      'memory.list', 'memory.update', 'memory.forget', 'memory.clear',
