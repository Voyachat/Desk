/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-jobs-local`.
 * @module @voyaseek-ai/dsh-jobs-local/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-jobs-local'
...
/**
 * No runtime invariant: `@voyaseek-ai/dsh-jobs/invariant` owns per-snapshot identity, status,
