/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-typert-protocol`.
 * @module @voyaseek-ai/dsh-typert-protocol/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-typert-protocol'
