/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-typert-registry`.
 * @module @voyaseek-ai/dsh-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-typert-registry'
