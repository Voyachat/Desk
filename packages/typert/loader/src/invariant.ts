/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-typert-loader`.
 * @module @voyaseek-ai/dsh-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-typert-loader'
