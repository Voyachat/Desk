/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-typert-generator`.
 * @module @voyaseek-ai/dsh-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-typert-generator'
