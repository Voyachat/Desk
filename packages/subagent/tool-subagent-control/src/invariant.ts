/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-subagent-control`.
 * @module @voyaseek-ai/dsh-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-subagent-control'
