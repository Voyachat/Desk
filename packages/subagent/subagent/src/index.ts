 ...
 * (`@voyaseek-ai/dsh-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@voyaseek-ai/dsh-tool-subagent`) are separate packages.
 *
...
import { scopeTarget } from '@voyaseek-ai/dsh-scope'
import type { Scoped } from '@voyaseek-ai/dsh-scope'
import { assertObjectJsonSchema } from '@voyaseek-ai/dsh-tools'
import type { ContentBlock, MessageId } from '@voyaseek-ai/dsh-llm'
