/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-subagent-codex`.
 * @module @voyaseek-ai/dsh-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-subagent-codex'
