 ...
 * @module @voyaseek-ai/dsh-tool-subagent
 */

import type { Context } from '@voyaseek-ai/cordis'
import z from '@voyaseek-ai/schemastery'
import { defineTool } from '@voyaseek-ai/dsh-tools'
import type { AgentOptions } from '@voyaseek-ai/dsh-agent'
import type { ContentBlock } from '@voyaseek-ai/dsh-llm'
import type { JsonValue } from '@voyaseek-ai/dsh-session'
import { assertSubagentMaxDepth, settleRun } from '@voyaseek-ai/dsh-subagent'
import type { SubagentProvider, SubagentResult, SubagentRun } from '@voyaseek-ai/dsh-subagent'
import type { JobOutcome } from '@voyaseek-ai/dsh-jobs'
