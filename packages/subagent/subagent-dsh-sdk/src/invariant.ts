/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-subagent-dsh-sdk`.
 * @module @voyaseek-ai/dsh-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-subagent-dsh-sdk'
