/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-subagent-report`.
 * @module @voyaseek-ai/dsh-tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-subagent-report'
