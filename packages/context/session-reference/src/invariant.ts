/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-reference`.
 * @module @voyaseek-ai/dsh-session-reference/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-reference'
