/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tmux-context`.
 * @module @voyaseek-ai/dsh-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tmux-context'
