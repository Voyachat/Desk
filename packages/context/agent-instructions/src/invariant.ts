/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-agent-instructions`.
 * @module @voyaseek-ai/dsh-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-agent-instructions'
