 ...
 *
 * @module @voyaseek-ai/dsh-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$VOYASEEK_HOME`.
 * Discovery (`$VOYASEEK_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.voyaseek/AGENTS.md' || displayPath === '$VOYASEEK_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
