/** JSON string-prefix accounting for the outer-output ledger. @module @voyaseek-ai/dsh-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@voyaseek-ai/dsh-code-runtime'
