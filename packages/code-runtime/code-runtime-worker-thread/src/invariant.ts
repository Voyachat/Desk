/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-code-runtime-worker-thread`.
 * @module @voyaseek-ai/dsh-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-code-runtime-worker-thread'
