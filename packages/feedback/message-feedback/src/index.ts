 ...
 * @module @voyaseek-ai/dsh-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@voyaseek-ai/cordis'
import s from '@voyaseek-ai/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@voyaseek-ai/dsh-session/surface'
import type { SessionHeader, SessionId } from '@voyaseek-ai/dsh-session/types'
import type { SessionInspection } from '@voyaseek-ai/dsh-session-persistence'
import type { KvTable } from '@voyaseek-ai/dsh-storage-domain'
