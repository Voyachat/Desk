...
import SessionStore, { foldSurface, Session, SessionId } from '@voyaseek-ai/dsh-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@voyaseek-ai/dsh-session-telemetry'
...
vi.mock('@voyaseek-ai/dsh-anonymous-user-id', () => ({
...
describe('@voyaseek-ai/dsh-command-feedback registration', () => {
