/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-command-feedback`.
 * @module @voyaseek-ai/dsh-command-feedback/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-command-feedback'
