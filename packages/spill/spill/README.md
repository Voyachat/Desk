...
| Package | Role |
|---|---|
| `@voyaseek-ai/dsh-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@voyaseek-ai/dsh-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@voyaseek-ai/dsh-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
