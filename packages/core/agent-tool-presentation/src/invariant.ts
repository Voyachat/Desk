/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-agent-tool-presentation`.
 * @module @voyaseek-ai/dsh-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-agent-tool-presentation'
