/** Package-owned scoped-dispatch invariants. @module @voyaseek-ai/dsh-scope/invariant */

import type { Context } from '@voyaseek-ai/cordis'
import type { InvariantInstaller } from '@voyaseek-ai/dsh-invariants'
import { carrierKeyOf, isScopeCarrier } from '@voyaseek-ai/dsh-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@voyaseek-ai/dsh-scope'
