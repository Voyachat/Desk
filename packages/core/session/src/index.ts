 ...
 *
 * @module @voyaseek-ai/dsh-session
 */

import { Context, Service } from '@voyaseek-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@voyaseek-ai/dsh-llm'
import { scopeOf, scopeTarget } from '@voyaseek-ai/dsh-scope'
import type { Scoped } from '@voyaseek-ai/dsh-scope'
import type { Message } from '@voyaseek-ai/dsh-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@voyaseek-ai/dsh-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@voyaseek-ai/dsh-llm'
...
function validateSessionHeader(id: SessionId, input: unknown): SessionHeader {
  ...
  if (record.agentRuntime !== undefined && typeof record.agentRuntime !== 'string') {
    throw new Error('session header agentRuntime must be a string')
  }
...
export class SessionStore extends Service {
  ...
  prepare(id?: SessionId, options?: PrepareSessionOptions): Session {
    ...
    const header: SessionHeader = {
      ...
      ...meta?.agentRuntime === undefined ? {} : { agentRuntime: meta.agentRuntime },
    }
