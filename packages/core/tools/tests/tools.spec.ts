...
import { createUserMessage, CallId, HarnessError, type ContentBlock  } from '@voyaseek-ai/dsh-llm'
import SystemPrompt from '@voyaseek-ai/dsh-system-prompt'
import type { Agent } from '@voyaseek-ai/dsh-agent'
import ApprovalService, { type ApprovalOutcome, type ApprovalRequest } from '@voyaseek-ai/dsh-user-approval'
import ToolRuntime, {
