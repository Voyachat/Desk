/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-subprocess-e2b`.
 * @module @voyaseek-ai/dsh-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-subprocess-e2b'
