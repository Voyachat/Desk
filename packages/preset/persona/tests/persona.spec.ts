...
import { createScope, type ScopeKey } from '@voyaseek-ai/dsh-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@voyaseek-ai/dsh-persona'
import { PERSONA_SECTION } from '@voyaseek-ai/dsh-persona'
