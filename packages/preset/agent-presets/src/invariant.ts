/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-agent-presets`.
 * @module @voyaseek-ai/dsh-agent-presets/invariant
 */
...
import { leakedServices, livePresetMounts } from '@voyaseek-ai/dsh-agent-presets'

const PACKAGE_NAME = '@voyaseek-ai/dsh-agent-presets'
