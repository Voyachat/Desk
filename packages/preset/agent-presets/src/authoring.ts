 ...
 * @module @voyaseek-ai/dsh-agent-presets/authoring
 */

import { chmod, cp, readdir, readFile, rm, stat } from 'node:fs/promises'
import { dirname, isAbsolute, join, resolve } from 'node:path'
import { writeFileAtomic } from '@voyaseek-ai/dsh-atomic-write'
import { expandHomePath } from '@voyaseek-ai/dsh-home-paths'
