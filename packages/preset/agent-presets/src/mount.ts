 ...
 * @module @voyaseek-ai/dsh-agent-presets/mount
 */
...
import type { EntryTree } from '@voyaseek-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@voyaseek-ai/dsh-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@voyaseek-ai/dsh-*` row would fail to import. The
