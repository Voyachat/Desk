 ...
 * @module @voyaseek-ai/dsh-agent-presets
 */

import { stat } from 'node:fs/promises'
import { Context, Service } from '@voyaseek-ai/cordis'
import z from '@voyaseek-ai/schemastery'
import { bindScopeParent, createScope, scopeOf, type Scope, type ScopeKey, type ScopeParentBinding } from '@voyaseek-ai/dsh-scope'
// Type-only: resolves the `agent/created` lifecycle event this service watches.
import type {} from '@voyaseek-ai/dsh-agent'
import { settingsNamespace, type SettingsScope, type default as SettingsService } from '@voyaseek-ai/dsh-settings'
