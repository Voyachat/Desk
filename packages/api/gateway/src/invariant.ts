/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-api-gateway`.
 * @module @voyaseek-ai/dsh-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-api-gateway'
