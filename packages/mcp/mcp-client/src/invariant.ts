/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-mcp-client`.
 * @module @voyaseek-ai/dsh-mcp-client/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-mcp-client'
