/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-sdk-jsonrpc-demo`.
 * @module @voyaseek-ai/dsh-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-sdk-jsonrpc-demo'
