/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-agent-spine-demo`.
 * @module @voyaseek-ai/dsh-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-agent-spine-demo'
