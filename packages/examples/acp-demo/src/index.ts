 ...
 * ({@link @voyaseek-ai/dsh-agent-spine-demo}), JSONL session persistence, and
 * the {@link @voyaseek-ai/dsh-acp} bridge. The app owns those plugins through one
 ...
 * @module @voyaseek-ai/dsh-acp-demo
 */

import type { Context } from '@voyaseek-ai/cordis'
import { join } from 'node:path'
import z from '@voyaseek-ai/schemastery'
import * as acp from '@voyaseek-ai/dsh-acp'
import * as agentCore from '@voyaseek-ai/dsh-agent-spine-demo'
...
} from '@voyaseek-ai/dsh-session-persistence-jsonl'
import * as sessionCheckpointPolicy from '@voyaseek-ai/dsh-session-checkpoint-policy'
