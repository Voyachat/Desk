 ...
 *
 * @module @voyaseek-ai/dsh-tool-fs-search/search-core
 */

import { isAbsolute, relative, sep } from 'node:path'
import type { Context } from '@voyaseek-ai/cordis'
import { HarnessError } from '@voyaseek-ai/dsh-llm'
import { ItemRetainer, TextRetainer } from '@voyaseek-ai/dsh-output-retention'
import type { RetainedItems } from '@voyaseek-ai/dsh-output-retention'
import type { SubprocessHandle, SubprocessOutcome, SubprocessOutputRead, SubprocessSpawnSpec } from '@voyaseek-ai/dsh-subprocess'
import type { SaveTextSpill, SpillRef } from '@voyaseek-ai/dsh-spill'
 ...
 * `@voyaseek-ai/dsh-tool-call-timeout-policy` to enforce through `exec.signal`.
 */
 ...
 * (`@voyaseek-ai/dsh-tool-call-timeout-policy`) and caller cancellation terminate the
 * process tree.
 *
 ...
 * retention pass both the model-facing render ({@link module:@voyaseek-ai/dsh-tool-fs-search/grep}
 * `formatGrepOutput`) and the search-card projection
 * ({@link module:@voyaseek-ai/dsh-tool-fs-search/presentation} `grepSearchMeta`)
