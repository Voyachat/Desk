/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-fs-search`.
 * @module @voyaseek-ai/dsh-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-fs-search'
