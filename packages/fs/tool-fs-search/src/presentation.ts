 ...
 * model-facing render consumes ({@link module:@voyaseek-ai/dsh-tool-fs-search/search-core}
 ...
 *
 * @module @voyaseek-ai/dsh-tool-fs-search/presentation
 */
 ...
 * ({@link module:@voyaseek-ai/dsh-tool-fs-search/grep} `formatGrepMatches`), so
