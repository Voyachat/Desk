 ...
 *
 * @module @voyaseek-ai/dsh-tool-fs-search/grep
 */

import type { Context } from '@voyaseek-ai/cordis'
import { defineTool } from '@voyaseek-ai/dsh-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@voyaseek-ai/dsh-tools'
import type { RetainedItems } from '@voyaseek-ai/dsh-output-retention'
import type { SpillRef } from '@voyaseek-ai/dsh-spill'
