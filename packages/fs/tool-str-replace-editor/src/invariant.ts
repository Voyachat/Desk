/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-str-replace-editor`.
 * @module @voyaseek-ai/dsh-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-str-replace-editor'
