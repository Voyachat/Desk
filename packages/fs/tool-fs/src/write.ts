 ...
 * @module @voyaseek-ai/dsh-tool-fs/src/write
 */

import type { Context } from '@voyaseek-ai/cordis'
import { defineTool } from '@voyaseek-ai/dsh-tools'
import type { DiffCallView, DiffResultView, ToolResult } from '@voyaseek-ai/dsh-tools'
import type { FsWriteOutcome } from '@voyaseek-ai/dsh-fs'
import type {} from '@voyaseek-ai/dsh-fs'
