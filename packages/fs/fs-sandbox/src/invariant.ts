/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-fs-sandbox`.
 * @module @voyaseek-ai/dsh-fs-sandbox/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-fs-sandbox'
