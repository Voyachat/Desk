 ...
 * `@voyaseek-ai/dsh-fs` Service Definition. It extends `LocalFileSystem` so all
 ...
 * stays `ctx.shell`'s job (`@voyaseek-ai/dsh-bash-sandbox`). This mirrors the
 ...
 * escalation retry lives in the tool layer (`@voyaseek-ai/dsh-tool-fs`),
 * exactly as bash's does.
 *
 * @module @voyaseek-ai/dsh-fs-sandbox
 */

import { Context } from '@voyaseek-ai/cordis'
import { LocalFileSystem } from '@voyaseek-ai/dsh-fs-local'
import type { Config as LocalConfig } from '@voyaseek-ai/dsh-fs-local'
import { FsError } from '@voyaseek-ai/dsh-fs'
import type { FsEditOutcome, FsEditRequest, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@voyaseek-ai/dsh-fs'
import { writableRoots } from '@voyaseek-ai/dsh-sandbox'
