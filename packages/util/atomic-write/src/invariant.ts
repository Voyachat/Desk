/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-atomic-write`.
 * @module @voyaseek-ai/dsh-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-atomic-write'
