/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-native-command`.
 * @module @voyaseek-ai/dsh-native-command/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-native-command'
