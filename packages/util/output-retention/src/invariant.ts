/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-output-retention`.
 * @module @voyaseek-ai/dsh-output-retention/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-output-retention'
