/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-launch-environment`.
 * @module @voyaseek-ai/dsh-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-launch-environment'
