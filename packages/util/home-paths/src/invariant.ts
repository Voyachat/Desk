/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-home-paths`.
 * @module @voyaseek-ai/dsh-home-paths/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-home-paths'
