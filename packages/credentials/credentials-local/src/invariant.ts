/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-credentials-local`.
 * @module @voyaseek-ai/dsh-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-credentials-local'
