 ...
 *
 * @module @voyaseek-ai/dsh-compaction-tool-result-pruner
 */

import { Context, Service } from '@voyaseek-ai/cordis'
import z from '@voyaseek-ai/schemastery'
import { freezeMessage } from '@voyaseek-ai/dsh-llm'
import type { ContentBlock } from '@voyaseek-ai/dsh-llm'
import type { Session, SessionEvent, ToolResultMessage } from '@voyaseek-ai/dsh-session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@voyaseek-ai/dsh-compaction'
