/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-compaction-tool-result-pruner`.
 * @module @voyaseek-ai/dsh-compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-compaction-tool-result-pruner'
