 ...
 *
 * The seam itself lives in `@voyaseek-ai/dsh-compaction`, which re-exports these
 ...
 *
 * @module @voyaseek-ai/dsh-compaction/checkpoint
 */

import type { MessageSource } from '@voyaseek-ai/dsh-llm/message'
