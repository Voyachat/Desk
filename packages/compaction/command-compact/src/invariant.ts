/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-command-compact`.
 * @module @voyaseek-ai/dsh-command-compact/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-command-compact'
