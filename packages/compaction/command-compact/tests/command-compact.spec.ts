...
import CommandRuntime, { type CommandResult } from '@voyaseek-ai/dsh-commands'
import {
  CompactionId,
  CompactionEngine,
...
import * as commandCompact from '@voyaseek-ai/dsh-command-compact'
...
describe('@voyaseek-ai/dsh-command-compact registration', () => {
