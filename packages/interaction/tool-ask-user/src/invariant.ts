/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-ask-user`.
 * @module @voyaseek-ai/dsh-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-ask-user'
