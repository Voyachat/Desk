/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-user-questions`.
 * @module @voyaseek-ai/dsh-user-questions/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-user-questions'
