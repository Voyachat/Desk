/** Package-owned permission-preset event invariants. @module @voyaseek-ai/dsh-permission-presets/invariant */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-permission-presets'
