...
import { TypertLookupFailure } from '@voyaseek-ai/dsh-typert-protocol'
import TypertRegistry from '@voyaseek-ai/dsh-typert-registry'
import { createUserMessage, MessageId } from '@voyaseek-ai/dsh-llm'
...
describe('Remote Agent and Session lookup policy', () => {
  it('deduplicates a cold resume across Agent and Session parameters', async () => {
    ...
    const resumedSession = { id: sessionId, header: meta, events: [] } as unknown as import('@voyaseek-ai/dsh-session').Session
