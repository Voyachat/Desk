/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-host-apiproxy`.
 * @module @voyaseek-ai/dsh-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-host-apiproxy'
