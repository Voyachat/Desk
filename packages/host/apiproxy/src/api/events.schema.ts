...
export const muxFrameSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('approval/requested'), sessionId: sessionIdSchema, approvalId: approvalRequestIdSchema, toolName: z.string(), callId: z.string().optional(), reason: z.string().optional(), rememberable: z.literal(true).optional() }),
  z.object({ type: z.literal('approval/resolved'), sessionId: sessionIdSchema, approvalId: approvalRequestIdSchema, outcome: z.union([z.literal('allowed-once'), z.literal('allowed-and-remembered'), z.literal('rejected'), z.literal('cancelled'), z.literal('unavailable')]) }),
