...
import type { AskUserQuestionItem } from '@voyaseek-ai/dsh-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@voyaseek-ai/dsh-user-approval/types'
import type { Message } from '@voyaseek-ai/dsh-llm/types'
import type { MessageId } from '@voyaseek-ai/dsh-llm/brand'
import type { CallId } from '@voyaseek-ai/dsh-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@voyaseek-ai/dsh-session/types'
import type { ToolCallView, ToolResultView } from '@voyaseek-ai/dsh-tools/presentation'
...
export type { ToolCallView, ToolResultView } from '@voyaseek-ai/dsh-tools/presentation'
...
export type MuxFrame =
  ...
  | { type: 'approval/requested'; sessionId: SessionId; approvalId: ApprovalRequestId; toolName: string; callId?: CallId; reason?: string; rememberable?: true }
...
export type HostFrame =
   ...
   * owned by `@voyaseek-ai/dsh-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
