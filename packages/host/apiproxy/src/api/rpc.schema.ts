...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('runtime-not-found'), message: z.string(), details: z.object({ agentRuntime: z.string(), available: z.array(z.string()) }) }),
  z.object({ code: z.literal('runtime-conflict'), message: z.string(), details: z.object({ sessionId: z.string(), requestedRuntime: z.string(), existingRuntime: z.string().optional() }) }),
