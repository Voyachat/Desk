...
import { z } from 'zod'
import type { ApprovalRequestId } from '@voyaseek-ai/dsh-user-approval/types'
...
export const approvalResponsePayloadSchema = z.object({
  ...
  outcome: z.union([z.literal('allowed-once'), z.literal('allowed-and-remembered'), z.literal('rejected')]),
