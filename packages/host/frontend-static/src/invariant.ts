/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-host-frontend-static`.
 * @module @voyaseek-ai/dsh-host-frontend-static/invariant
 */

import type { Context } from '@voyaseek-ai/cordis'
import type { InvariantInstaller } from '@voyaseek-ai/dsh-invariants'

const PACKAGE_NAME = '@voyaseek-ai/dsh-host-frontend-static'
