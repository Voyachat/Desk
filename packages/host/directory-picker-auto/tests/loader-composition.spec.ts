...
import type { DirectoryPicker } from '@voyaseek-ai/dsh-host-directory-picker'
import BrowseDirectoryPicker from '@voyaseek-ai/dsh-host-directory-picker-browse'
import NativeDirectoryPicker from '@voyaseek-ai/dsh-host-directory-picker-native'
...
const AUTO = '@voyaseek-ai/dsh-host-directory-picker-auto'
const NATIVE = '@voyaseek-ai/dsh-host-directory-picker-native'
const BROWSE = '@voyaseek-ai/dsh-host-directory-picker-browse'
const NATIVE_SURFACE = '@voyaseek-ai/dsh-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@voyaseek-ai/dsh-client-ui-directory-picker-browse'
