 ...
 * @module @voyaseek-ai/dsh-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@voyaseek-ai/dsh-host-directory-picker-native',
  browse: '@voyaseek-ai/dsh-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@voyaseek-ai/dsh-client-ui-directory-picker-native',
  browse: '@voyaseek-ai/dsh-client-ui-directory-picker-browse',
}
