/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-host-webserver`.
 * @module @voyaseek-ai/dsh-host-webserver/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-host-webserver'
