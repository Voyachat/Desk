/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-skill-badge`.
 * @module @voyaseek-ai/dsh-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-skill-badge'
