/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-skill`.
 * @module @voyaseek-ai/dsh-tool-skill/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-skill'
