 ...
 * Concrete
 * providers such as `@voyaseek-ai/dsh-skill-filesystem` decide where skills come
 ...
 *
 * @module @voyaseek-ai/dsh-skill
 */

import { Context, Service } from '@voyaseek-ai/cordis'
import { assertNever } from '@voyaseek-ai/dsh-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@voyaseek-ai/dsh-scope'
import type { ScopeKey, ScopeLayer } from '@voyaseek-ai/dsh-scope'
