/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-terminal`.
 * @module @voyaseek-ai/dsh-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-terminal'
