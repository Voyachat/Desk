 ...
 * @module @voyaseek-ai/dsh-tool-terminal
 */
...
import { TerminalSessionId } from '@voyaseek-ai/dsh-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@voyaseek-ai/dsh-terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @voyaseek-ai/dsh-jobs and @voyaseek-ai/dsh-tool-jobs')
