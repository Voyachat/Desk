/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-terminal-bash`.
 * @module @voyaseek-ai/dsh-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-terminal-bash'
