 ...
 * @module @voyaseek-ai/dsh-cordis-host-runner/types
 */

import type { Branded } from '@voyaseek-ai/dsh-brand'
import type { JsonValue, SessionId } from '@voyaseek-ai/dsh-session/types'
...
export interface DynamicCordisInventoryRow {
  ...
  /** Stable editable paths for the latest immutable Package's present halves. */
  developmentSources?: { host?: string; client?: string }
  /** Last development watcher failure; the active artifact remains unchanged. */
  developmentBuildError?: { message: string; sourcePath?: string }
}
