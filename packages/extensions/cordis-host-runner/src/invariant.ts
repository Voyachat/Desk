/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-cordis-host-runner`.
 * @module @voyaseek-ai/dsh-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-cordis-host-runner'
