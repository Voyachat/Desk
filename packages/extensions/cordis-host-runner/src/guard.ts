 ...
 * @module @voyaseek-ai/dsh-cordis-host-runner/guard
 */

import { Context } from '@voyaseek-ai/cordis'
import type { Plugin } from '@voyaseek-ai/cordis'
import { scopeOf } from '@voyaseek-ai/dsh-scope'
import { assertSupportedJsonSchema, defineTool } from '@voyaseek-ai/dsh-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@voyaseek-ai/dsh-cordis-client-runner`, whose CTX_VERBS names this one its
