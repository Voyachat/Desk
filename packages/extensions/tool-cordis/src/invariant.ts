/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-cordis`.
 * @module @voyaseek-ai/dsh-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-cordis'
