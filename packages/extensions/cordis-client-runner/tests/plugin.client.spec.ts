...
import InvariantService from '@voyaseek-ai/dsh-invariants'
import type {
...
import type { DynamicCordisInvokeResult } from '@voyaseek-ai/dsh-api-remotes/client'
// Type-only: resolves `ctx.remote` and with it the `$on`/`$dispatch` surface.
import type {} from '@voyaseek-ai/dsh-api-gateway/client'
