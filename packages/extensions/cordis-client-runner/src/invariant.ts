/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-cordis-client-runner`.
 * @module @voyaseek-ai/dsh-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-cordis-client-runner'
