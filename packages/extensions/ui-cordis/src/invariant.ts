/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-ui-cordis`.
 * @module @voyaseek-ai/dsh-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-ui-cordis'
