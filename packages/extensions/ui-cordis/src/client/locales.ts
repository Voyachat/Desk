...
export const zh = {
  ...
  'panel.developmentSource': '开发源码：{path}',
  'panel.developmentBuildFailed': '开发构建失败（{path}）：{message}',
  'action.approve': '允许',
...
export const en = {
  ...
  'panel.developmentSource': 'Development source: {path}',
  'panel.developmentBuildFailed': 'Development build failed ({path}): {message}',
