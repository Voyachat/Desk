...
| [`tool-plugin-discovery/`](tool-plugin-discovery/README.md) | 精选 DSH 插件发现线索 | 注册到 `ctx.tools` |
| [`tool-modelscope/`](tool-modelscope/README.md) | 只读搜索 ModelScope Hub 官方模型目录 | 注册到 `ctx.tools` |
