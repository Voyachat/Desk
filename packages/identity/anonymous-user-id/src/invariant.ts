/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-anonymous-user-id`.
 * @module @voyaseek-ai/dsh-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-anonymous-user-id'
