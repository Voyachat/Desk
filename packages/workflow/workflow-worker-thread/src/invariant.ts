/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-workflow-worker-thread`.
 * @module @voyaseek-ai/dsh-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-workflow-worker-thread'
