 ...
 * @module @voyaseek-ai/dsh-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@voyaseek-ai/dsh-llm'
import { SessionId } from '@voyaseek-ai/dsh-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@voyaseek-ai/dsh-tools'
import type { ObjectJsonSchema } from '@voyaseek-ai/dsh-tools'
import { isFatalWorkflowError, WorkflowError } from '@voyaseek-ai/dsh-workflow'
import type {
