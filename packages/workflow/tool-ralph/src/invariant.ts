/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-ralph`.
 * @module @voyaseek-ai/dsh-tool-ralph/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-ralph'
