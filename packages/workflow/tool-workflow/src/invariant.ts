/** Package-owned durable workflow-record invariants. @module @voyaseek-ai/dsh-tool-workflow/invariant */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-workflow'
...
function applyEvent(trace: WorkflowTrace, event: SessionEvent, fail: InvariantFailure): void {
  ...
  switch (event.type) {
    case 'tool-workflow/run-start': {
      ...
      stringId(data.callId, 'tool-workflow/run-start callId', fail)
