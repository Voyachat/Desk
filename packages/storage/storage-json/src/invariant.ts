/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-storage-json`.
 * @module @voyaseek-ai/dsh-storage-json/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-storage-json'
