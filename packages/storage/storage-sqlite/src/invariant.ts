/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-storage-sqlite`.
 * @module @voyaseek-ai/dsh-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-storage-sqlite'
