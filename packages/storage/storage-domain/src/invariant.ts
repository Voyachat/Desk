/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-storage-domain`: every
 ...
 * @module @voyaseek-ai/dsh-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-storage-domain'
