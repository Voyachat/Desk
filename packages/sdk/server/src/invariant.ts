/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-sdk-jsonrpc-server`.
 * @module @voyaseek-ai/dsh-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-sdk-jsonrpc-server'
