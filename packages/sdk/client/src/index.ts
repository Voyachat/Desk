/**
 * TypeScript client SDK for the Voyaseek Harness runtime: spawn the
 * `dsh-jsonrpc-agent` runtime as a subprocess and drive agent turns over
 * stdio JSON-RPC. `VoyaseekHarness` is the high-level run API;
 ...
 *
 * @module @voyaseek-ai/dsh-sdk-client
 */

export { VoyaseekHarness, HarnessSession } from './api.ts'
...
export { JsonRpcResponseError } from '@voyaseek-ai/dsh-sdk-protocol'
export type {
  ContentBlock,
  VoyaseekHarnessOptions,
