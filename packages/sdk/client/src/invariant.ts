/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-sdk-client`.
 * @module @voyaseek-ai/dsh-sdk-client/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-sdk-client'
