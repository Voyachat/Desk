/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-sdk-protocol`.
 * @module @voyaseek-ai/dsh-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-sdk-protocol'
