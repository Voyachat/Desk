 ...
 * @module @voyaseek-ai/dsh-session-persistence-sqlite
 */
...
} from '@voyaseek-ai/dsh-session-persistence'
import type { SessionEvent, SurfaceEventType, SessionId, SessionHeader, SessionPreparation } from '@voyaseek-ai/dsh-session'
import {
  ...
  private writeRow(meta: SessionHeader): void {
    this.db.prepare(`
      INSERT INTO sessions
        (id, version, created_at, cwd, parent_session, seed_length, origin, delegation_depth, agent_preset, agent_runtime, incarnation, revision)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0)
