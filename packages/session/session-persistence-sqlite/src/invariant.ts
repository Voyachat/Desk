/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-persistence-sqlite`.
 * @module @voyaseek-ai/dsh-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-persistence-sqlite'
