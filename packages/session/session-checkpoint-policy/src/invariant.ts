/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-checkpoint-policy`.
 * @module @voyaseek-ai/dsh-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-checkpoint-policy'
