/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-title-all-prompts-llm`.
 * @module @voyaseek-ai/dsh-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-title-all-prompts-llm'
