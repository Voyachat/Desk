/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-projection-cache`.
 * @module @voyaseek-ai/dsh-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-projection-cache'
