 ...
 * @module @voyaseek-ai/dsh-session-persistence
 */

import { Context, Service } from '@voyaseek-ai/cordis'
import { SessionPreparation } from '@voyaseek-ai/dsh-session'
import type { SessionEvent, SessionId, SessionHeader } from '@voyaseek-ai/dsh-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@voyaseek-ai/dsh-session'
