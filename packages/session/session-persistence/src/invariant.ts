/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-persistence`.
 * @module @voyaseek-ai/dsh-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-persistence'
