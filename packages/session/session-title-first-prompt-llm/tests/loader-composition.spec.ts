...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@voyaseek-ai/dsh-llm'
...
import SessionTitleService from '@voyaseek-ai/dsh-session-title'
import * as providerPlugin from '@voyaseek-ai/dsh-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@voyaseek-ai/dsh-session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@voyaseek-ai/dsh-session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@voyaseek-ai/dsh-session-title', SessionTitleService],
    ['@voyaseek-ai/dsh-session-title-first-prompt-llm', providerPlugin],
  ])
