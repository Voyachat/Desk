/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-title-first-prompt-llm`.
 * @module @voyaseek-ai/dsh-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-title-first-prompt-llm'
