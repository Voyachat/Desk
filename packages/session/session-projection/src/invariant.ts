/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-projection`.
 * @module @voyaseek-ai/dsh-session-projection/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-projection'
