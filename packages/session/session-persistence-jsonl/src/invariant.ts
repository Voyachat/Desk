/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-persistence-jsonl`.
 * @module @voyaseek-ai/dsh-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-persistence-jsonl'
