/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-title`.
 * @module @voyaseek-ai/dsh-session-title/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-title'
