 ...
 * @module @voyaseek-ai/dsh-session-title
 */

import { Context, FiberState, Service, type Fiber } from '@voyaseek-ai/cordis'
import z from '@voyaseek-ai/schemastery'
import { z as zod } from 'zod'
import type { Branded } from '@voyaseek-ai/dsh-brand'
import { assertNever, deepFreeze, isAgentLoopRequest } from '@voyaseek-ai/dsh-llm'
import type { GenerateOptions } from '@voyaseek-ai/dsh-llm'
import type {
  Session,
  SessionEvent,
