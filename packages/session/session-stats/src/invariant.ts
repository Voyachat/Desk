/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-stats`.
 * @module @voyaseek-ai/dsh-session-stats/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-stats'
