/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-telemetry`.
 * @module @voyaseek-ai/dsh-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-telemetry'
