/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-title-llm`.
 * @module @voyaseek-ai/dsh-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-title-llm'
