 ...
 * @module @voyaseek-ai/dsh-session-title-llm
 */

import type { Context } from '@voyaseek-ai/cordis'
import z from '@voyaseek-ai/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@voyaseek-ai/dsh-llm'
import type { FinishReason, GenerateOptions, Message } from '@voyaseek-ai/dsh-llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@voyaseek-ai/dsh-timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@voyaseek-ai/dsh-session-title'
import type {
