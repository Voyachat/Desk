/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-telemetry-otel`.
 * @module @voyaseek-ai/dsh-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-telemetry-otel'
