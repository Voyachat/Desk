/**
 * OpenTelemetry Service Provider for the Voyaseek Harness telemetry capability.
 *
 ...
 *
 * @module @voyaseek-ai/dsh-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@voyaseek-ai/schemastery'
import type { Context } from '@voyaseek-ai/cordis'
import type {} from '@voyaseek-ai/dsh-command-feedback'
import {
...
} from '@voyaseek-ai/dsh-session-telemetry'
import { APP_IDENTITY } from '@voyaseek-ai/dsh-llm'
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@voyaseek-ai/dsh-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@voyaseek-ai/dsh-session-telemetry-otel/ops', version)
