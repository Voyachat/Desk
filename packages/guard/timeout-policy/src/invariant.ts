/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-call-timeout-policy`.
 * @module @voyaseek-ai/dsh-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-call-timeout-policy'
