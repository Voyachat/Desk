/**
 * Unit + real-load-path coverage for @voyaseek-ai/dsh-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@voyaseek-ai/dsh-llm'
import SystemPrompt from '@voyaseek-ai/dsh-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@voyaseek-ai/dsh-tools'
import * as timeoutPolicy from '@voyaseek-ai/dsh-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@voyaseek-ai/dsh-tool-call-timeout-policy'
