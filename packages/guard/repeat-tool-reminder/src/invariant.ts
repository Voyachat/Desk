/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-repeat-tool-reminder`.
 * @module @voyaseek-ai/dsh-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-repeat-tool-reminder'
