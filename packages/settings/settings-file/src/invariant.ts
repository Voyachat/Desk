/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-settings-file`.
 * @module @voyaseek-ai/dsh-settings-file/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@voyaseek-ai/dsh-settings`.
 */
