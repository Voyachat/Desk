/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-invariants`.
 * @module @voyaseek-ai/dsh-invariants/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-invariants'
