/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-workspace`.
 * @module @voyaseek-ai/dsh-workspace/invariant
 */
...
import { WorkspaceId } from '@voyaseek-ai/dsh-workspace'

const PACKAGE_NAME = '@voyaseek-ai/dsh-workspace'
