/** Package-owned goal-round prompt invariants. @module @voyaseek-ai/dsh-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@voyaseek-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@voyaseek-ai/dsh-goal'
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-goal-round-driver'
