/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-command-goal`.
 * @module @voyaseek-ai/dsh-command-goal/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-command-goal'
