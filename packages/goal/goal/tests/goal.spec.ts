...
import AgentRegistry, { agentEvents, Inbox } from '@voyaseek-ai/dsh-agent'
import type { Agent } from '@voyaseek-ai/dsh-agent'
import { createUserMessage, HarnessError } from '@voyaseek-ai/dsh-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@voyaseek-ai/dsh-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@voyaseek-ai/dsh-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@voyaseek-ai/dsh-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@voyaseek-ai/dsh-session').SessionEvent[]): StubAgent {
