...
import type { ShellExecRequest, ShellExecSpec, ShellExecutor, ShellRunResult } from '@voyaseek-ai/dsh-shell'
import { DEFAULT_HOOK_TIMEOUT_MS, runHook } from '@voyaseek-ai/dsh-hook-protocol'
import type { RunHookOptions } from '@voyaseek-ai/dsh-hook-protocol'
