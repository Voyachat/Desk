/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-hooks-codex`.
 * @module @voyaseek-ai/dsh-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-hooks-codex'
