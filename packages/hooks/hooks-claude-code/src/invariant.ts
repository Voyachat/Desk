/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-hooks-claude-code`.
 * @module @voyaseek-ai/dsh-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-hooks-claude-code'
