/**
 * Real-process tests for `@voyaseek-ai/dsh-pwsh-local`: the LOCAL subprocess
...
import { PwshLocalExecutor, ENCODING_PREAMBLE, candidatePwshPaths, resolvePwshPath } from '@voyaseek-ai/dsh-pwsh-local'
...
import type { SubprocessHandle, SubprocessOutputReader, SubprocessSpawnSpec } from '@voyaseek-ai/dsh-subprocess'
import { MAX_TIMER_DELAY_MS } from '@voyaseek-ai/dsh-timeout'
import type { ShellProcess } from '@voyaseek-ai/dsh-shell'
