/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-pwsh-sandbox`.
 * @module @voyaseek-ai/dsh-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-pwsh-sandbox'
