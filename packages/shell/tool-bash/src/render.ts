 ...
 *
 * @module @voyaseek-ai/dsh-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@voyaseek-ai/dsh-shell'
import type { SandboxMode } from '@voyaseek-ai/dsh-sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@voyaseek-ai/dsh-sandbox'
 ...
 * rendering story, owned by `@voyaseek-ai/dsh-shell` so `dsh-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@voyaseek-ai/dsh-shell'
