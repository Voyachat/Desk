 ...
 * `@voyaseek-ai/dsh-pwsh-local`) backs `ctx.shell`; the tool contract is
 ...
 * exit-status parse from `@voyaseek-ai/dsh-shell`.
 *
 * @module @voyaseek-ai/dsh-tool-pwsh
 */

import { isAbsolute, resolve as resolvePath } from 'node:path'
import type { Context } from '@voyaseek-ai/cordis'
import z from '@voyaseek-ai/schemastery'
import { defineTool, TOOL_ABORTED } from '@voyaseek-ai/dsh-tools'
import type { GenericCallView, TerminalCallView, ToolExecution, ToolResult, ToolResultView } from '@voyaseek-ai/dsh-tools'
...
import type { SandboxExecutionPolicy, SandboxMode } from '@voyaseek-ai/dsh-sandbox'
import { ESCALATION_TARGETS, approveEscalation, validateEscalationArgs } from '@voyaseek-ai/dsh-sandbox'
import type { SandboxPolicyService } from '@voyaseek-ai/dsh-sandbox-policy'
import type { ShellRunResult } from '@voyaseek-ai/dsh-shell'
import { parseExitStatus } from '@voyaseek-ai/dsh-shell'
import { processOutcome } from './background.ts'
import { renderPwshProcessRead, renderPwshResult } from './render.ts'
import type { RenderablePwshResult } from './render.ts'

declare module '@voyaseek-ai/dsh-jobs' {
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: PwshToolArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) {
          throw new Error('background jobs unavailable: load @voyaseek-ai/dsh-jobs and @voyaseek-ai/dsh-tool-jobs')
        }
