/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-tool-session-query`.
 * @module @voyaseek-ai/dsh-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-tool-session-query'
