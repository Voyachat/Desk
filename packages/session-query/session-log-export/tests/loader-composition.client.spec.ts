...
import * as SessionLogDownload from '@voyaseek-ai/dsh-session-log-export'
...
describe('session-log-download real Loader composition', () => {
  it('discovers and executes /export through the assembled command plane', async () => {
    ...
    await writeFile(configPath, [
      ...
      "- name: '@voyaseek-ai/dsh-session-log-export'",
      '',
    ].join('\n'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@voyaseek-ai/dsh-session-log-export', SessionLogDownload],
    ])
