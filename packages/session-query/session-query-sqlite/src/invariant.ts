/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-query-sqlite`.
 * @module @voyaseek-ai/dsh-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-query-sqlite'
