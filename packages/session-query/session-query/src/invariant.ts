/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-session-query`.
 * @module @voyaseek-ai/dsh-session-query/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-session-query'
