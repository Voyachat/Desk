...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@voyaseek-ai/dsh-llm'
import type { AppIdentity } from '@voyaseek-ai/dsh-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `voyaseek-harness/${manifest.version} (+https://github.com/voyaseek-ai/voyaseek-harness)`,
    )
  })
