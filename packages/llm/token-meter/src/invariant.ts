/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-token-meter`.
 * @module @voyaseek-ai/dsh-token-meter/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-token-meter'
