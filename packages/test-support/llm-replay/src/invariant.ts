/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-llm-replay`.
 * @module @voyaseek-ai/dsh-llm-replay/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-llm-replay'
