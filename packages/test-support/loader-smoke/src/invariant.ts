/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-loader-smoke`.
 * @module @voyaseek-ai/dsh-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-loader-smoke'
