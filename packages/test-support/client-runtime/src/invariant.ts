/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-client-test-runtime`.
 * @module @voyaseek-ai/dsh-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-client-test-runtime'
