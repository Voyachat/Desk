/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-acp-snapshot`.
 * @module @voyaseek-ai/dsh-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-acp-snapshot'
