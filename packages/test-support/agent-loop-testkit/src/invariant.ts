/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-agent-loop-testkit`.
 * @module @voyaseek-ai/dsh-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-agent-loop-testkit'
