/**
 * Package-owned invariant companion for `@voyaseek-ai/dsh-llm-mock-server`.
 * @module @voyaseek-ai/dsh-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-llm-mock-server'
