 ...
 * tool family (`@voyaseek-ai/dsh-tool-bash`, `@voyaseek-ai/dsh-tool-fs`): the
 ...
 */
export type EscalationOutcome = 'allowed-once' | 'allowed-and-remembered' | 'rejected' | 'cancelled' | 'unavailable'
...
export async function approveEscalation<A, C>(request: EscalationRequest, approval: EscalationApproval<A, C>): Promise<SandboxMode> {
  ...
  switch (outcome) {
    ...
    case 'allowed-and-remembered': throw new Error('sandbox escalation does not support remembered approval')
