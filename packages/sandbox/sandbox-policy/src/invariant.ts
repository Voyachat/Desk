/** Package-owned session-event invariants for sandbox policy. @module @voyaseek-ai/dsh-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@voyaseek-ai/dsh-sandbox-policy'
