 ...
 *
 * @module @voyaseek-ai/dsh-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@voyaseek-ai/node-addon-landlock-run'
 ...
 * (`@voyaseek-ai/dsh-fs-sandbox`) can never drift apart.
