...
import { LAUNCHER_FAILURE_EXIT } from '@voyaseek-ai/node-addon-landlock-run'
import { SANDBOX_UNAVAILABLE, SandboxUnavailableError } from '@voyaseek-ai/dsh-sandbox'
import type { SandboxPolicy } from '@voyaseek-ai/dsh-sandbox'
import {
  LocalSandboxProvider,
} from '@voyaseek-ai/dsh-sandbox-local'
import type { Config } from '@voyaseek-ai/dsh-sandbox-local'
...
describe('the platform chains', () => {
  ...
  // live in @voyaseek-ai/dsh-sandbox-windows-acl/tests/provider-chain.spec.ts
