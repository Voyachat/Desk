...
import { LOADER_SMOKE_TEST_TIMEOUT_MS, resolveExampleLaunch } from '@voyaseek-ai/dsh-loader-smoke'
...
async function runHeadlessPtySmoke(): Promise<string> {
  ...
  try {
    ...
    await writeFile(join(profileDir, 'package.json'), JSON.stringify({
      ...
      private: true,
      dependencies: {},
      dsh: { profile: { bundles: ['@voyaseek-ai/dsh-base', '@voyaseek-ai/dsh-headless'] } },
    }, undefined, 2))
