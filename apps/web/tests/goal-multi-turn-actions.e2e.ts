...
import { parseSessionLog } from '@voyaseek-ai/dsh-llm-replay'
import type { SessionEvent, SessionId } from '@voyaseek-ai/dsh-session'
import type {} from '@voyaseek-ai/dsh-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@voyaseek-ai/dsh-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@voyaseek-ai/dsh-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@voyaseek-ai/dsh-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@voyaseek-ai/dsh-skill-filesystem"}\n',
