...
import type { WebBootEntry } from '@voyaseek-ai/dsh-client-modules/client'
import { AppWebEntry } from '@voyaseek-ai/dsh-client-web'
...
const PLUGINS: readonly (WebBootEntry & { bundlePath: string })[] = [
  { id: '@voyaseek-ai/dsh-typert-registry', bundlePath: 'packages/typert/registry/lib/client.js', url: '/plugins/typert-registry.js', rev: 'fx', inject: [], immediately: true },
  { id: '@voyaseek-ai/dsh-client-connection', bundlePath: 'packages/client/connection/lib/client.js', url: '/plugins/connection.js', rev: 'fx', inject: [], immediately: true },
  { id: '@voyaseek-ai/dsh-api-gateway', bundlePath: 'packages/api/gateway/lib/client.js', url: '/plugins/api-gateway.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-typert-registry', '@voyaseek-ai/dsh-client-connection'], immediately: true },
  { id: '@voyaseek-ai/dsh-api-remotes', bundlePath: 'packages/api/remotes/lib/client.js', url: '/plugins/api-remotes.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-api-gateway'], immediately: true },
  ...
  { id: '@voyaseek-ai/dsh-client-ui-settings', bundlePath: 'packages/client/ui-settings/lib/client.js', url: '/plugins/ui-settings.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-connection', '@voyaseek-ai/dsh-client-runtime', '@voyaseek-ai/dsh-api-remotes'], immediately: true },
  { id: '@voyaseek-ai/dsh-client-runtime', bundlePath: 'packages/client/runtime/lib/client.js', url: '/plugins/runtime.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-connection', '@voyaseek-ai/dsh-typert-registry', '@voyaseek-ai/dsh-api-gateway'], immediately: true },
  { id: '@voyaseek-ai/dsh-client-ui-theme', bundlePath: 'packages/client/ui-theme/lib/client.js', url: '/plugins/ui-theme.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-connection', '@voyaseek-ai/dsh-client-runtime', '@voyaseek-ai/dsh-client-locale', '@voyaseek-ai/dsh-client-ui-settings', '@voyaseek-ai/dsh-api-remotes'], immediately: true },
  { id: '@voyaseek-ai/dsh-client-locale', bundlePath: 'packages/client/locale/lib/client.js', url: '/plugins/locale.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-connection', '@voyaseek-ai/dsh-client-runtime', '@voyaseek-ai/dsh-client-ui-settings', '@voyaseek-ai/dsh-api-remotes'], immediately: true },
  { id: '@voyaseek-ai/dsh-client-ui-layout', bundlePath: 'packages/client/ui-layout/lib/client.js', url: '/plugins/ui-layout.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-runtime'] },
  { id: '@voyaseek-ai/dsh-client-ui-sidebar', bundlePath: 'packages/client/ui-sidebar/lib/client.js', url: '/plugins/ui-sidebar.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-ui-layout'] },
  { id: '@voyaseek-ai/dsh-client-ui-conversation', bundlePath: 'packages/client/ui-conversation/lib/client.js', url: '/plugins/ui-conversation.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-ui-layout'] },
  { id: '@voyaseek-ai/dsh-client-ui-tool', bundlePath: 'packages/client/ui-tool/lib/client.js', url: '/plugins/ui-tool.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-runtime', '@voyaseek-ai/dsh-client-locale', '@voyaseek-ai/dsh-client-ui-conversation'] },
  { id: '@voyaseek-ai/dsh-client-ui-workflow-run', bundlePath: 'packages/client/ui-workflow-run/lib/client.js', url: '/plugins/ui-workflow-run.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-locale', '@voyaseek-ai/dsh-client-runtime', '@voyaseek-ai/dsh-client-ui-conversation'] },
  {
    id: '@voyaseek-ai/dsh-client-ui-workspace',
    bundlePath: 'packages/client/ui-workspace/lib/client.js',
    url: '/plugins/ui-workspace.js',
    rev: 'fx',
    inject: [
      '@voyaseek-ai/dsh-client-runtime',
      '@voyaseek-ai/dsh-client-ui-conversation',
      '@voyaseek-ai/dsh-client-ui-sidebar',
    ],
  },
  { id: '@voyaseek-ai/dsh-session-log-export', bundlePath: 'packages/session-query/session-log-export/lib/client.js', url: '/plugins/session-log-download.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-ui-commands', '@voyaseek-ai/dsh-client-ui-conversation'] },
  { id: '@voyaseek-ai/dsh-client-ui-trajectory', bundlePath: 'packages/client/ui-trajectory/lib/client.js', url: '/plugins/ui-trajectory.js', rev: 'fx', inject: ['@voyaseek-ai/dsh-client-ui-conversation'] },
]
