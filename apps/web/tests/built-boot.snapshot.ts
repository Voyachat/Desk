...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@voyaseek-ai/dsh-client-ui-layout', '@voyaseek-ai/dsh-client-ui-sidebar', '@voyaseek-ai/dsh-client-ui-conversation', '@voyaseek-ai/dsh-client-ui-tool']) {
