...
```text
@voyaseek-ai/dsh-tool-web  --depends on-->  @voyaseek-ai/dsh-web  <--depends on--  @voyaseek-ai/dsh-web-search-exa
        consumer                                 interface                       implementation
                                                                 <--depends on--  @voyaseek-ai/dsh-web-search-perplexity
                                                                                  implementation
                                                                 <--depends on--  @voyaseek-ai/dsh-web-search-deepseek
                                                                                  implementation
                                                                 <--depends on--  @voyaseek-ai/dsh-web-fetch-http
                                                                                  implementation
```
...
```mermaid
flowchart LR
  exa["@voyaseek-ai/dsh-web-search-exa"] -->|registerSearchProvider| web["@voyaseek-ai/dsh-web / ctx.web"]
  perplexity["@voyaseek-ai/dsh-web-search-perplexity"] -->|registerSearchProvider| web
  deepseek["@voyaseek-ai/dsh-web-search-deepseek"] -->|registerSearchProvider| web
  fetchLocal["@voyaseek-ai/dsh-web-fetch-http"] -->|registerFetchProvider| web
  toolWeb["@voyaseek-ai/dsh-tool-web"] -->|search/fetch| web
...
```ts
import type { WebFetchRequest, WebFetchResult, WebSearchRequest, WebSearchResult } from '@voyaseek-ai/dsh-web'
...
```yaml
- id: web
  name: '@voyaseek-ai/dsh-web'
  config:
    searchProvider: exa
    fetchProvider: http

- id: web-search-exa
  name: '@voyaseek-ai/dsh-web-search-exa'

- id: web-search-perplexity
  name: '@voyaseek-ai/dsh-web-search-perplexity'

- id: web-search-deepseek
  name: '@voyaseek-ai/dsh-web-search-deepseek'

- id: web-fetch-http
  name: '@voyaseek-ai/dsh-web-fetch-http'

- id: tool-web
  name: '@voyaseek-ai/dsh-tool-web'
```
