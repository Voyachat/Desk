...
class VoyaseekHarness:
    """Reusable synchronous SDK for running Voyaseek Harness agent turns.
    ...
    def __init__(self, config: VoyaseekHarnessConfig | None = None, **kwargs: object) -> None:
        if config is not None and kwargs:
            raise TypeError("pass either VoyaseekHarnessConfig or keyword options, not both")
        self.config = config or VoyaseekHarnessConfig(**kwargs)
    ...
    def __enter__(self) -> "VoyaseekHarness":
        self.start()
        return self
...
class Session:
    def __init__(self, harness: VoyaseekHarness, session_id: str) -> None:
